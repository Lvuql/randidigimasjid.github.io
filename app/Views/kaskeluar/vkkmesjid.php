...
<!-- TAMBAH DATA -->
<form action="/kaskeluar/savemesjid" method="post">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="col-md-12 mb-2">
                        <?php
                        $totalmasuk = 0;
                        foreach ($mesjid as $val) {
                            $totalmasuk += $val['totalmasuk'];
                        }

                        $totalkeluar = 0;
                        foreach ($mesjidk as $val) {
...
<!-- HAPUS DATA -->
<form action="/kaskeluar/deletemesjid" method="post">
...
<!-- edit modal -->
<form action="/kaskeluar/updatemesjid" method="post">
